          ...
          <TabsContent value="examples" className="mt-0">
            <Card className="rounded-xl border shadow-sm">
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-base">
                  Examples for using the URL Shortener API in different
                  languages
                </CardDescription>
              </CardHeader>
                  ...
                  <div className="bg-muted flex items-start gap-3 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <p className="text-primary font-medium">
                        Coming soon: A direct download link will be available
                        here to get our ready-to-use URL Shortener iOS Shortcut.
                      </p>
                    </div>
                  </div>
                </div>
